...
const (
	UserService_Register_FullMethodName    = "/template.UserService/Register"
	UserService_Login_FullMethodName       = "/template.UserService/Login"
	UserService_GetUserInfo_FullMethodName = "/template.UserService/GetUserInfo"
)
